...
class RNInAppStorySDKModule: RCTEventEmitter {
  ...
  @objc func initWith(
    ...
    InAppStory.shared.gameReaderWillShow = {
      RNInAppStorySDKModule.emitter.sendEvent(
        withName: "gameReaderWillShow",
        body: []
      )
    }
    InAppStory.shared.gameReaderDidClose = {
      RNInAppStorySDKModule.emitter.sendEvent(
        withName: "gameReaderDidClose",
        body: []
      )
    }
    ...
    InAppStory.shared.favoriteCellDidSelect = {
      RNInAppStorySDKModule.emitter.sendEvent(
        withName: "favoriteCellDidSelect",
        body: []
      )
    }
    InAppStory.shared.editorCellDidSelect = {
      RNInAppStorySDKModule.emitter.sendEvent(
        withName: "editorCellDidSelect",
        body: []
      )
    }
  ...
  @objc
  func setPlaceholders(_ placeholders: [String: String]) {
    DispatchQueue.main.async {
  ...
  func cancelOperation(_ operationId: String) {
    if let token = cancellationTokenMap[operationId] {
      token.cancel()
    }
  ...
  func showOnboardings(
    ...
    DispatchQueue.main.async {
      ...
      self.cancellationTokenMap[operationId] = cancellationToken
    }
  }
