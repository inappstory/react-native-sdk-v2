...
#ifndef INAPPSTORYSDK_SWIFT_H
#define INAPPSTORYSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="InAppStorySDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13InAppStorySDK19DownloadPlaceholder")
@interface DownloadPlaceholder : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_PROTOCOL("_TtP13InAppStorySDK25LottiePlaceholderProtocol_")
@protocol LottiePlaceholderProtocol
...
@interface DownloadPlaceholder (SWIFT_EXTENSION(InAppStorySDK)) <LottiePlaceholderProtocol>
- (void)setAnimationData:(NSData * _Nullable)data;
- (void)setMinTime:(NSInteger)time;
- (void)finishAnimationWith:(void (^ _Nonnull)(void))complete;
@end
...
SWIFT_PROTOCOL("_TtP13InAppStorySDK22EditorDownloadProtocol_")
@protocol EditorDownloadProtocol
+ (void)cancel;
@end


SWIFT_CLASS("_TtC13InAppStorySDK21EditorDownloadService")
@interface EditorDownloadService : NSObject <EditorDownloadProtocol>
...
@interface EditorDownloadService (SWIFT_EXTENSION(InAppStorySDK)) <NSURLSessionDataDelegate>
...
typedef SWIFT_ENUM(NSInteger, ScrollStyle, open) {
  ScrollStyleFlat = 0,
  ScrollStyleCover = 1,
  ScrollStyleCube = 2,
  ScrollStyleDepth = 3,
...
SWIFT_CLASS("_TtC13InAppStorySDK12StoryUGCView")
