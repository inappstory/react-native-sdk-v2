...
RCT_EXTERN_METHOD(setLikeImage:(NSString *)image selected:(NSString *)selectedImage)
RCT_EXTERN_METHOD(setDislikeImage:(NSString *)image selected:(NSString *)selectedImage)
RCT_EXTERN_METHOD(setFavoriteImage:(NSString *)image selected:(NSString *)selectedImage)
RCT_EXTERN_METHOD(setShareImage:(NSString *)image selected:(NSString *)selectedImage)
RCT_EXTERN_METHOD(setSoundImage:(NSString *)image selected:(NSString *)selectedImage)
