package com.inappstory.reactnativesdk.modules

import com.inappstory.reactnativesdk.NativeStoryManagerSpec
...
import com.inappstory.reactnativesdk.appearance.AppearanceManagerImpl
import com.inappstory.sdk.stories.api.models.ImagePlaceholderValue;
import com.facebook.react.bridge.Promise
import com.facebook.react.modules.core.DeviceEventManagerModule
import com.inappstory.reactnativesdk.activity.NativeOverlayFragment
...
class StoryManagerModule(var reactContext: ReactApplicationContext) :
  ...
  // Single source for the JS story payload — updateStoryData (one story) and
  // updateStoriesData (the list) build the exact same shape.
  ...
  fun subscribeLists(inAppStoryAPI: InAppStoryAPI, feed: String, uniqueId: String = feed) {
    inAppStoryAPI.addSubscriber(object : InAppStoryAPIListSubscriber(uniqueId) {
      ...
      override fun updateStoryData(story: StoryAPIData, sessionData: IASStoryListSessionData) {
        ...
        val payload = storyPayload(story, payloadFeed, payloadList, aspectRatio)
      ...
      override fun updateStoriesData(
        ...
        for (item in iterator) {
          val storyData = storyPayload(item, payloadFeed, payloadList, aspectRatio)
          Log.e(TAG, "Item = $item")
